...
from .colors import cyan, green, success
...
def fetch_all_problems() -> List[Dict]:
    ...
    """
    print(cyan(f'[cf-api] Fetching problem list from {CF_API_URL} ...'))
    ...
    print(success(f'[cf-api] Fetched {len(valid_problems)} problems from CF API'))
